...
This guide provides comprehensive documentation for the **patterns** skill in the custom-plugin-javascript plugin.
...
```bash
# Invoke the skill
claude "patterns - [your task description]"

# Example
claude "patterns - analyze the current implementation"
```
...
def implement_patterns(input_data):
    """
    Implement patterns functionality.
